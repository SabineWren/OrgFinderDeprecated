...
Members  (front end) == Size  (database)
	*/
	...
	$prepared_select = $connection->prepare("SELECT Size, Main, Affiliate, Hidden, DATEDIFF( CURDATE(), ScrapeDate ) as DaysAgo FROM tbl_OrgMemberHistory WHERE Organization = ? ORDER BY DaysAgo DESC");
